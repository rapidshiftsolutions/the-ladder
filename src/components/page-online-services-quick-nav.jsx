...
const OnlineServicesQuickNavigation = () => {
  ...
  const navLinks = [
    { href: "/online-banking", text: "Online Banking" },
    { href: "/mobile-banking", text: "Mobile Banking" },
    { href: "/estatements", text: "eStatements" },
    { href: "/estatements-login", text: "eStatements Login" }
  ];
...
export default OnlineServicesQuickNavigation;