// Treasury Management Quick Navigation (Component 1)
"use client";

import React, { useState, useRef, useEffect } from 'react';
import Link from 'next/link';

const TreasuryQuickNavigation = () => {
  ...
  const navLinks = [
    { href: "/treasury-management-online-banking", text: "Online Banking" },
    { href: "/treasury-management-remote-deposit", text: "Remote Deposit" },
    { href: "/treasury-management-sweep-services", text: "Sweep Services" },
    { href: "/treasury-management-estatements", text: "eStatements" },
    { href: "/treasury-management-positive-pay", text: "Positive Pay" }
  ];
  ...
  return (
    <div className="top-0 z-30 py-2 pt-4 px-4 sm:px-6 border-b border-gray-100 shadow-sm bg-gray-100">
      <div className="relative max-w-7xl mx-auto">
        <h2 className="sr-only">Treasury Management Services Navigation</h2>
...
export default TreasuryQuickNavigation;