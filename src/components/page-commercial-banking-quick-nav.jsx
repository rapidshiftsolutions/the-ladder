// Commercial Banking Quick Navigation (Component 2)
"use client";

import React, { useState, useRef, useEffect } from 'react';
import Link from 'next/link';

const CommercialQuickNavigation = () => {
  const [showScrollButtons, setShowScrollButtons] = useState(false);
  const [activeLink, setActiveLink] = useState(null);
  const scrollContainerRef = useRef(null);
  
  const navLinks = [
    { href: "/commercial-banking-checking", text: "Checking Accounts" },
    { href: "/commercial-banking-money-market", text: "Money Market" },
    { href: "/commercial-banking-fee-schedule-and-requirements", text: "Fee Schedule" },
    { href: "/commercial-banking-debit-card-monitoring", text: "Debit Card Monitoring" },
  ...
  return (
    <div className="top-0 z-30 py-2 pt-4 px-4 sm:px-6 border-b border-gray-100 shadow-sm bg-gray-100">
      <div className="relative max-w-7xl mx-auto">
        <h2 className="sr-only">Commercial Banking Services Navigation</h2>
...
export default CommercialQuickNavigation;