// components/page-commercial-banking-account-card.jsx
import React from 'react';

const AccountCard = ({ title, features, footnote }) => {
  return (
    <div className="bg-white p-6 rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col">
      ...
      {footnote && (
        <p className="mt-4 text-xs text-gray-500 pt-3 border-t border-gray-100">
          {footnote}
        </p>
      )}
    </div>
