// components/page-personal-banking-common-features.jsx
import React from 'react';
import Link from 'next/link';

const CommonFeatures = () => {
  const features = [
    "Free Visa Check or ATM Card",
  ...
  return (
    <div className="mt-10 bg-white p-8 rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
      <h3 className="text-2xl font-normal tracking-tight text-gray-900 mb-6">
        All of our Personal Checking Accounts include:
      </h3>
      ...
      <div className="mt-6 pt-5 border-t border-gray-100 text-sm text-gray-600">
        <p className="mb-1">
          For more information on personal fee schedules and account
          requirements, view our <Link className="text-primary-600 hover:text-primary-800 underline transition-colors" href="/personal-banking-fee-schedule-and-requirements">Comparison Chart</Link>.
        </p>
      </div>
    </div>
  );
