...
// Standalone client component for resource preloading
// This is a completely self-contained component to avoid import issues
export default function ClientResourcePreloader() {
  useEffect(() => {
    // Only run in browser
